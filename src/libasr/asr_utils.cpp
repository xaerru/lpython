...
ASR::expr_t *type_enum_to_asr_expr(Allocator &al, enum TTYPE_T t, const Location &l, std::string n,
    ...
    case F64:
        ...
        break;
    case STR:
        type = ASRUtils::TYPE(ASR::make_String_t(al, l, 1, -2, nullptr, ASR::PointerString));
        break;
    case PTR:
    ...
    ASR::symbol_t *v = ASR::down_cast<ASR::symbol_t>(ASRUtils::make_Variable_t_util(al, l, current_scope, s.c_str(al), nullptr,
